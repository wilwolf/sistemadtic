...
<div style="text-align:right">
    <span style="position: absolute;   ;
        top: 410; left: 185; width: 680px; height: 40px; font-size: 17px; font-family: sans-serif !important">El Alto, {{ \Carbon\Carbon::parse('02-08-2021')->isoFormat('DD [de] MMMM  YYYY') }} </span>
</div>
<div style="text-align:center">
    <span style="position: absolute;   ;
