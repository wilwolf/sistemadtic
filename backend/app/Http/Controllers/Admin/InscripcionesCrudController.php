...
class InscripcionesCrudController extends CrudController
{
     ...
     */
     public function eventoTitulo(){
        ...
        $datos = DB::table('eventos')
                                ...
                                ->select( 'eventos.id as id_evento', DB::raw('CONCAT(titulos.nombre, " | ",eventos.modalidad, "-",eventos.version) as nombre ') ) 
    ...
    public function listaEstudiantes(){
        $nuevoArray = array();
        $datos = \App\Models\Estudiantes::select('estudiantes.id', DB::raw('CONCAT(estudiantes.carnet, "|",estudiantes.nombre," ",estudiantes.apellidos) as nombre')) 
                                       ->get()->toArray();
        //print_r($datos);exit();
        foreach($datos as $dato){
